  ...
  const areasData: Area[] = [
    {
      ...
      attractions: [
        {
          name: "חוף הים בתל אביב",
          url: "https://www.tel-aviv.gov.il/eng/",
          mapsUrl: "https://www.google.com/maps?q=tel+aviv+beach",
          imageUrl: "https://upload.wikimedia.org/wikipedia/commons/a/ab/Tel_Aviv_Beach.jpg",
        },
        {
          name: "מוזיאון תל אביב לאומניות",
          url: "https://www.tamuseum.org.il/en/",
          mapsUrl: "https://www.google.com/maps?q=Tel+Aviv+Museum+of+Art",
          imageUrl: "https://upload.wikimedia.org/wikipedia/commons/a/a0/Tel_Aviv_Museum_of_Art.jpg",
        },
      ],
      restaurants: [
        {
          name: "מסעדת 'מול ים'",
          url: "https://www.mulyam.co.il/",
          mapsUrl: "https://www.google.com/maps?q=MULYAM+restaurant",
          imageUrl: "https://upload.wikimedia.org/wikipedia/commons/0/0b/Restaurant_Icon.jpg",
        },
      ],
      hotels: [
        {
          name: "מלון דיויד אינטרקונטיננטל",
          url: "https://www.danhotels.com/david-intercontinental",
          mapsUrl: "https://www.google.com/maps?q=Intercontinental+Hotel+Tel+Aviv",
          imageUrl: "https://upload.wikimedia.org/wikipedia/commons/e/e6/Intercontinental_Hotel_Tel_Aviv.jpg",
        },
      ],
      siteUrl: "https://www.tel-aviv.gov.il/eng/",
      mapsUrl: "https://www.google.com/maps/place/Tel+Aviv",
    },
    {
      ...
      attractions: [
        {
          name: "כותל המערבי",
          url: "https://www.itsyourjerusalem.com/he/%d7%94%d7%9b%d7%95%d7%aa%d7%9c-%d7%94%d7%9e%d7%a2%d7%a8%d7%91%d7%99/",
          mapsUrl: "https://www.google.com/maps?q=Western+Wall",
          imageUrl: "https://upload.wikimedia.org/wikipedia/commons/d/d9/Western_Wall.jpg",
        },
      ],
      restaurants: [
        {
          name: "המסעדה האיטלקית 'דומיניקו'",
          url: "https://www.dominico.co.il/",
          mapsUrl: "https://www.google.com/maps?q=Dominico+Restaurant",
          imageUrl: "https://upload.wikimedia.org/wikipedia/commons/0/0f/Dominico.jpg",
        },
      ],
      hotels: [
        {
          name: "מלון המלך דוד",
          url: "https://www.kingdavidhotel.co.il/",
          mapsUrl: "https://www.google.com/maps?q=King+David+Hotel",
          imageUrl: "/img/king_david.jpg",
        },
      ],
      siteUrl: "https://www.jerusalem.muni.il/en/",
      mapsUrl: "https://www.google.com/maps/place/Jerusalem",
    ...
    <div>
      {step === 1 && (
        <div>
          <h1>בחר אזור:</h1>
          {areasData.map((area) => (
            <button key={area.id} onClick={() => handleAreaSelect(area)}>
              {area.name}
            </button>
          ))}
        </div>
      ...
      {step === 2 && selectedArea && (
        <div>
          ...
          <button onClick={() => handleCategorySelect("attractions")}>
            אטרקציות
          </button>
          <button onClick={() => handleCategorySelect("restaurants")}>
            מסעדות
          </button>
          <button onClick={() => handleCategorySelect("hotels")}>
            מלונות
          </button>
      ...
      {step === 3 && selectedArea && selectedCategory && (
        <div>
          <h1>{selectedCategory}</h1>
          {selectedArea[selectedCategory].map((item: Item, index: number) => (
      ...
      {step === 4 && selectedItem && (
        <div>
          ...
          <a href={selectedItem.url}>לינק למידע נוסף</a>
          <a href={selectedItem.mapsUrl}>צפה במפה</a>
