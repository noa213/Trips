...
// //   siteUrl: string;
// //   mapsUrl: string;
// //   [key: string]: Attraction[] | Restaurant[] | Hotel[] | string;
// // };
...
// const Information_for_the_traveler: React.FC = () => {
//   const [step, setStep] = useState<number>(1);
//   const [selectedArea, setSelectedArea] = useState<Area | null>(null);
//   const [selectedCategory, setSelectedCategory] = useState<"attractions" | "restaurants" | "hotels" | null>(null);
//   const [selectedItem, setSelectedItem] = useState<Item | null>(null);
...
//         <img src={selectedItem.imageUrl} alt={selectedItem.name} className="w-full h-64 object-cover rounded-lg mt-4" />
//         <div className="mt-4">
//           <a href={selectedItem.url} target="_blank" className="text-blue-500 hover:text-blue-700">Visit Website</a>
//         </div>
//       </div>
//     );
//   };
