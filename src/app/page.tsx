...
//   return (
//     <div className="relative min-h-screen bg-[#F5E0C3]"> {/* צבע בז' כרקע */}
//       {/* ה-overlay על הרקע */}
//       <div className="flex items-center justify-center min-h-screen bg-opacity-60 bg-[#9B111E] text-white">
//         <h1 className="text-4xl md:text-6xl font-bold text-center">
//           ברוך הבא ל-Triply
//           <br />
//           התחל לתכנן את הטיול הבא שלך!
...
//       {/* הצגת התמונות בגריד מחולק ל-3 */}
//       <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 py-12 px-4">
//         {images.map((src, index) => (
//           <div key={index} className="w-full">
//             <img src={src} alt={`תמונה ${index + 1}`} className="w-full h-auto rounded-lg shadow-lg"/>
//           </div>
//         ))}
//       </div>
