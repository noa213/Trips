...
const Home = () => {
  ...
  return (
    ...
    <div className="relative min-h-screen bg-gray-100 relative w-full h-[80vh]">
      <Header />
      {/* כותרת ותוכן ראשי */}
      <div
      ...
      >
        <p className="text-4xl font-yellowtail font-bold mb-4 text-[#66BB6A] text-center block">Welcome to</p>
        <h1 className="text-6xl font-yellowtail font-bold mb-4 text-[#66BB6A] text-center block">STEPS</h1>
        <p className="text-4xl font-yellowtail font-bold mb-4 text-[#66BB6A] text-center block">Discover the world and plan your perfect trip!</p>
      </div>
